...
useSeoMeta({
  ...
  description: 'Enter your two-factor authentication code below to log in',
  keywords:
  ...
  ogDescription: 'Enter your two-factor authentication code below to log in',
  ...
  twitterDescription:
    'Enter your two-factor authentication code below to log in',
