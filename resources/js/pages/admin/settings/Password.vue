...
import { edit } from '@/routes/admin/settings/user-password';
...
useSeoMeta({
  title: `Password settings - ${setting.value?.site_name || 'Forge Player'}`,
  ...
  ogTitle: `Password settings - ${setting.value?.site_name || 'Forge Player'}`,
  ogDescription: "Update your account's password settings",
  ogImage: setting.value?.site_og_image || '/images/logo.png',
  twitterCard: 'summary_large_image',
  twitterTitle: `Password settings - ${setting.value?.site_name || 'Forge Player'}`,
  twitterDescription: "Update your account's password settings",
