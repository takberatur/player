...
useSeoMeta({
  title: `Profile settings - ${setting.value?.site_name || 'Forge Player'}`,
  ...
  ogTitle: `Profile settings - ${setting.value?.site_name || 'Forge Player'}`,
  ogDescription: "Update your account's profile settings",
  ogImage: setting.value?.site_og_image || '/images/logo.png',
  twitterCard: 'summary_large_image',
  twitterTitle: `Profile settings - ${setting.value?.site_name || 'Forge Player'}`,
  twitterDescription: "Update your account's profile settings",
